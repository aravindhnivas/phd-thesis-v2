...
% \begin{figure}[!htb]
%     \centering
%     \includegraphics[scale=0.3]{figures/intro/energy_levels.png}
%     \caption{Schematic drawing of quantized energy levels for rotational, vibrational and electronic states. (The quantum states are not in scale, however, it serves the purpose of illustrating the energy of rotational, vibrational and electronic transition.)}
