...
Fourier-transform spectroscopy is a powerful technique used in the field of spectroscopy to obtain a high-resolution spectrum of molecules.
It is based on the Fourier transform of a time-domain signal, which is obtained by measuring the intensity of light emitted or absorbed by the molecules as a function of time.
