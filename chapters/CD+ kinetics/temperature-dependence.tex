...
The dependence of $k_{CID}$ to temperature has been discussed by \citet{SGA2015}
...
The very small computed value in the dissociation rate coefficient perhaps due to the fact that the    
